...
\begin{document}
	...
	\begin{ganttchart}[
		hgrid,
		vgrid,
		x unit=0.70cm, % Adjust this value for scaling the chart
		y unit title=0.8cm,
		y unit chart=1cm,
		title height=1,
		title/.append style={fill=blue!20},
		time slot unit=month, % Use months as the time slot unit
		...
		inline,
		bar inline label node/.style={font=\tiny},
		milestone inline label node/.style={font=\tiny},
		]{2023-01-01}{2024-9-01} % Specify the start and end months
		
		\gantttitle{Week}{21} \\
		
		\ganttgroup{Investigación}{2023-01-01}{2023-02-28} \\
		\ganttbar{Recopilación de necesidades}{2023-01-01}{2023-02-28} \\
		
		\ganttgroup{Planeación}{2023-03-01}{2023-05-31} \\
		\ganttbar{Definir metodología}{2023-03-01}{2023-03-31} \\
		\ganttbar{Capacitación en los lenguajes}{2023-04-01}{2023-06-30} \\
		\ganttbar{Definición de tareas}{2023-05-30}{2023-06-10} \\
		
		\ganttgroup{Diseño}{2023-07-01}{2023-12-31} \\
		\ganttbar{Maquetado}{2023-07-01}{2023-08-31} \\
		\ganttbar{Prototipo}{2023-09-01}{2023-10-31} \\
		\ganttbar{Diseño de BD}{2023-11-01}{2023-11-30} \\
		\ganttbar{Diseño de API}{2023-12-01}{2024-01-31} \\
		
		\ganttgroup{Testeo y Debug}{2024-02-01}{2024-07-31} \\
		\ganttbar{Debug de errores gráficos}{2024-02-01}{2024-03-31} \\
		\ganttbar{Test de Carga}{2024-04-01}{2024-04-30} \\
		\ganttbar{Test a interfaz}{2024-05-01}{2024-05-31} \\
		\ganttbar{Test de Seguridad}{2024-06-01}{2024-06-30} \\
		
		\ganttmilestone{Entrega}{2024-08-01} \\
